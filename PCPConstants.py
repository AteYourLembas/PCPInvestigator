...
#
SEARCH_SLEEPTIME = 15 # seconds to sleep between searches so Google doesn't block your IP
SITE_SLEEPTIME = 10 # seconds between site searches for the same reason